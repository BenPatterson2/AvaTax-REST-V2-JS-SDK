 ...
 */var _isomorphicFetch=require('isomorphic-fetch');var _isomorphicFetch2=_interopRequireDefault(_isomorphicFetch);var _basic_auth=require('./utils/basic_auth');function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}function _objectDestructuringEmpty(obj){if(obj==null)throw new TypeError("Cannot destructure undefined");}function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}var AvaTaxClient=function(){/**
   ...
   * @param object headers     additional headers to be included to calls to the rest api
   */function AvaTaxClient(_ref){var appName=_ref.appName,appVersion=_ref.appVersion,machineName=_ref.machineName,environment=_ref.environment,headers=_ref.headers;_classCallCheck(this,AvaTaxClient);this.baseUrl='https://rest.avatax.com';if(environment=='sandbox'){this.baseUrl='https://sandbox-rest.avatax.com';}else if(/^(https:\/\/|http:\/\/)/.test(environment)){this.baseUrl=environment;}this.clientId=appName+'; '+appVersion+'; JavascriptSdk; 19.11.0; '+machineName;this.headers=_extends({Accept:'application/json','Content-Type':'application/json','X-Avalara-Client':this.clientId},headers||{});}/**
   ...
   * @return AvaTaxClient
   */_createClass(AvaTaxClient,[{key:'withSecurity',value:function withSecurity(_ref2){var username=_ref2.username,password=_ref2.password,accountId=_ref2.accountId,licenseKey=_ref2.licenseKey,bearerToken=_ref2.bearerToken;if(username!=null&&password!=null){this.auth=(0,_basic_auth.createBasicAuthHeader)(username,password);}else if(accountId!=null&&licenseKey!=null){this.auth=(0,_basic_auth.createBasicAuthHeader)(accountId,licenseKey);}else if(bearerToken!=null){this.auth='Bearer '+bearerToken;}return this.withHeaders({Authorization:this.auth});}/**
   * Add additional headers to the client
   *
   * @param  object headers  And additional set of key value pairs of  headers to be used on the client 
   * @return AvaTaxClient
   */},{key:'withHeaders',value:function withHeaders(headers){this.headers=_extends({},this.headers,headers);return this;}/**
   * Private function to be used inside of th
   *
   ...
   */},{key:'createRestOptions',value:function createRestOptions(verb,payload){var headers=this.headers;if(/^(get|head)$/i.test(verb)){if(!!payload){throw new Error('Payload/body cannot be defined for GET/HEAD requests');}return{headers:headers,method:verb};}return{headers:headers,body:JSON.stringify(payload),method:verb};}/**
   * Make a single REST call to the AvaTax v2 API server
   *
   * @param   string  url        The relative path of the API on the server
   * @param   string  verb       The HTTP verb being used in this request
   * @param   string  payload    The request body, if this is being sent to a POST/PUT API call
   */},{key:'restCall',value:function restCall(_ref3){var url=_ref3.url,verb=_ref3.verb,payload=_ref3.payload;var options=this.createRestOptions(verb,payload);return(0,_isomorphicFetch2.default)(url,options).then(function(res){var contentHeaders=res.headers&&res.headers._headers&&res.headers._headers['content-type'];var contentType=contentHeaders&&contentHeaders[0];if(contentType==='application/vnd.ms-excel'||contentType==='text/csv'){return res;}return res.json();}).then(function(json){// handle error
...
url=url+'?'+qs;}return this.baseUrl+url;}/**
   ...
   * 
     ...
     * @param string orderBy A comma separated list of sort statements in the format `(fieldname) [ASC|DESC]`, for example `id ASC`.
   * @return FetchResult
   */},{key:'listCertificateAttributes',value:function listCertificateAttributes(){var _ref88=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},filter=_ref88.filter,top=_ref88.top,skip=_ref88.skip,orderBy=_ref88.orderBy;var path=this.buildUrl({url:'/api/v2/definitions/certificateattributes',parameters:{$filter:filter,$top:top,$skip:skip,$orderBy:orderBy}});return this.restCall({url:path,verb:'get',payload:null});}/**
   ...
   * 
     * @param int id 
   * @return object
   */},{key:'approveFirmClientLinkage',value:function approveFirmClientLinkage(){var _ref148=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},id=_ref148.id;var path=this.buildUrl({url:'/api/v2/firmclientlinkages/'+id+'/approve',parameters:{}});return this.restCall({url:path,verb:'post',payload:null});}/**
   ...
   * @return object
   */},{key:'createAndLinkNewFirmClientAccount',value:function createAndLinkNewFirmClientAccount(){var _ref149=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},model=_ref149.model;var path=this.buildUrl({url:'/api/v2/firmclientlinkages/createandlinkclient',parameters:{}});return this.restCall({url:path,verb:'post',payload:model});}/**
   ...
   * @return object
   */},{key:'createFirmClientLinkage',value:function createFirmClientLinkage(){var _ref150=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},model=_ref150.model;var path=this.buildUrl({url:'/api/v2/firmclientlinkages',parameters:{}});return this.restCall({url:path,verb:'post',payload:model});}/**
   * Delete a linkage
   *
   ...
   * 
     * @param int id 
   * @return object[]
   */},{key:'deleteFirmClientLinkage',value:function deleteFirmClientLinkage(){var _ref151=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},id=_ref151.id;var path=this.buildUrl({url:'/api/v2/firmclientlinkages/'+id,parameters:{}});return this.restCall({url:path,verb:'delete',payload:null});}/**
   ...
   * 
     * @param int id 
   * @return object
   */},{key:'getFirmClientLinkage',value:function getFirmClientLinkage(){var _ref152=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},id=_ref152.id;var path=this.buildUrl({url:'/api/v2/firmclientlinkages/'+id,parameters:{}});return this.restCall({url:path,verb:'get',payload:null});}/**
   ...
   * @return FetchResult
   */},{key:'listFirmClientLinkage',value:function listFirmClientLinkage(){var _ref153=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},filter=_ref153.filter;var path=this.buildUrl({url:'/api/v2/firmclientlinkages',parameters:{$filter:filter}});return this.restCall({url:path,verb:'get',payload:null});}/**
   ...
   * 
     * @param int id 
   * @return object
   */},{key:'rejectFirmClientLinkage',value:function rejectFirmClientLinkage(){var _ref154=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},id=_ref154.id;var path=this.buildUrl({url:'/api/v2/firmclientlinkages/'+id+'/reject',parameters:{}});return this.restCall({url:path,verb:'post',payload:null});}/**
   ...
   * 
     * @param int id 
   * @return object
   */},{key:'resetFirmClientLinkage',value:function resetFirmClientLinkage(){var _ref155=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},id=_ref155.id;var path=this.buildUrl({url:'/api/v2/firmclientlinkages/'+id+'/reset',parameters:{}});return this.restCall({url:path,verb:'post',payload:null});}/**
   ...
   * 
     * @param int id 
   * @return object
   */},{key:'revokeFirmClientLinkage',value:function revokeFirmClientLinkage(){var _ref156=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},id=_ref156.id;var path=this.buildUrl({url:'/api/v2/firmclientlinkages/'+id+'/revoke',parameters:{}});return this.restCall({url:path,verb:'post',payload:null});}/**
   ...
   * @return object
   */},{key:'requestFreeTrial',value:function requestFreeTrial(){var _ref157=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},model=_ref157.model;var path=this.buildUrl({url:'/api/v2/accounts/freetrials/request',parameters:{}});return this.restCall({url:path,verb:'post',payload:model});}/**
   ...
   * @return object
   */},{key:'taxRatesByAddress',value:function taxRatesByAddress(){var _ref158=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},line1=_ref158.line1,line2=_ref158.line2,line3=_ref158.line3,city=_ref158.city,region=_ref158.region,postalCode=_ref158.postalCode,country=_ref158.country;var path=this.buildUrl({url:'/api/v2/taxrates/byaddress',parameters:{line1:line1,line2:line2,line3:line3,city:city,region:region,postalCode:postalCode,country:country}});return this.restCall({url:path,verb:'get',payload:null});}/**
   ...
   * 
     ...
     * @param string postalCode The postal code of the location.
   * @return object
   */},{key:'taxRatesByPostalCode',value:function taxRatesByPostalCode(){var _ref159=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},country=_ref159.country,postalCode=_ref159.postalCode;var path=this.buildUrl({url:'/api/v2/taxrates/bypostalcode',parameters:{country:country,postalCode:postalCode}});return this.restCall({url:path,verb:'get',payload:null});}/**
   ...
   * @return object
   */},{key:'activateFundingRequest',value:function activateFundingRequest(){var _ref160=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},id=_ref160.id;var path=this.buildUrl({url:'/api/v2/fundingrequests/'+id+'/widget',parameters:{}});return this.restCall({url:path,verb:'get',payload:null});}/**
   ...
   * 
     * @param int id The unique ID number of this funding request
   * @return object
   */},{key:'fundingRequestStatus',value:function fundingRequestStatus(){var _ref161=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},id=_ref161.id;var path=this.buildUrl({url:'/api/v2/fundingrequests/'+id,parameters:{}});return this.restCall({url:path,verb:'get',payload:null});}/**
   ...
   * @return object[]
   */},{key:'batchDeleteItemClassifications',value:function batchDeleteItemClassifications(){var _ref162=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyId=_ref162.companyId,itemId=_ref162.itemId;var path=this.buildUrl({url:'/api/v2/companies/'+companyId+'/items/'+itemId+'/classifications',parameters:{}});return this.restCall({url:path,verb:'delete',payload:null});}/**
   ...
   * @return object[]
   */},{key:'batchDeleteItemParameters',value:function batchDeleteItemParameters(){var _ref163=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyId=_ref163.companyId,itemId=_ref163.itemId;var path=this.buildUrl({url:'/api/v2/companies/'+companyId+'/items/'+itemId+'/parameters',parameters:{}});return this.restCall({url:path,verb:'delete',payload:null});}/**
   ...
   * @return object[]
   */},{key:'createItemClassifications',value:function createItemClassifications(){var _ref164=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyId=_ref164.companyId,itemId=_ref164.itemId,model=_ref164.model;var path=this.buildUrl({url:'/api/v2/companies/'+companyId+'/items/'+itemId+'/classifications',parameters:{}});return this.restCall({url:path,verb:'post',payload:model});}/**
   ...
   * @return object[]
   */},{key:'createItemParameters',value:function createItemParameters(){var _ref165=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyId=_ref165.companyId,itemId=_ref165.itemId,model=_ref165.model;var path=this.buildUrl({url:'/api/v2/companies/'+companyId+'/items/'+itemId+'/parameters',parameters:{}});return this.restCall({url:path,verb:'post',payload:model});}/**
   * Create a new item
   *
   ...
   * @return object[]
   */},{key:'createItems',value:function createItems(){var _ref166=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyId=_ref166.companyId,model=_ref166.model;var path=this.buildUrl({url:'/api/v2/companies/'+companyId+'/items',parameters:{}});return this.restCall({url:path,verb:'post',payload:model});}/**
   ...
   * @return object[]
   */},{key:'deleteItem',value:function deleteItem(){var _ref167=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyId=_ref167.companyId,id=_ref167.id;var path=this.buildUrl({url:'/api/v2/companies/'+companyId+'/items/'+id,parameters:{}});return this.restCall({url:path,verb:'delete',payload:null});}/**
   ...
   * @return object[]
   */},{key:'deleteItemClassification',value:function deleteItemClassification(){var _ref168=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyId=_ref168.companyId,itemId=_ref168.itemId,id=_ref168.id;var path=this.buildUrl({url:'/api/v2/companies/'+companyId+'/items/'+itemId+'/classifications/'+id,parameters:{}});return this.restCall({url:path,verb:'delete',payload:null});}/**
   ...
   * @return object[]
   */},{key:'deleteItemParameter',value:function deleteItemParameter(){var _ref169=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyId=_ref169.companyId,itemId=_ref169.itemId,id=_ref169.id;var path=this.buildUrl({url:'/api/v2/companies/'+companyId+'/items/'+itemId+'/parameters/'+id,parameters:{}});return this.restCall({url:path,verb:'delete',payload:null});}/**
   ...
   * 
     ...
     * @param string include A comma separated list of additional data to retrieve.
   * @return object
   */},{key:'getItem',value:function getItem(){var _ref170=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyId=_ref170.companyId,id=_ref170.id,include=_ref170.include;var path=this.buildUrl({url:'/api/v2/companies/'+companyId+'/items/'+id,parameters:{$include:include}});return this.restCall({url:path,verb:'get',payload:null});}/**
   ...
   * 
     ...
     * @param int id The item classification id.
   * @return object
   */},{key:'getItemClassification',value:function getItemClassification(){var _ref171=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyId=_ref171.companyId,itemId=_ref171.itemId,id=_ref171.id;var path=this.buildUrl({url:'/api/v2/companies/'+companyId+'/items/'+itemId+'/classifications/'+id,parameters:{}});return this.restCall({url:path,verb:'get',payload:null});}/**
   ...
   * 
     ...
     * @param int id The parameter id
   * @return object
   */},{key:'getItemParameter',value:function getItemParameter(){var _ref172=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyId=_ref172.companyId,itemId=_ref172.itemId,id=_ref172.id;var path=this.buildUrl({url:'/api/v2/companies/'+companyId+'/items/'+itemId+'/parameters/'+id,parameters:{}});return this.restCall({url:path,verb:'get',payload:null});}/**
   ...
   * 
     ...
     * @param string orderBy A comma separated list of sort statements in the format `(fieldname) [ASC|DESC]`, for example `id ASC`.
   * @return FetchResult
   */},{key:'listItemClassifications',value:function listItemClassifications(){var _ref173=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyId=_ref173.companyId,itemId=_ref173.itemId,filter=_ref173.filter,top=_ref173.top,skip=_ref173.skip,orderBy=_ref173.orderBy;var path=this.buildUrl({url:'/api/v2/companies/'+companyId+'/items/'+itemId+'/classifications',parameters:{$filter:filter,$top:top,$skip:skip,$orderBy:orderBy}});return this.restCall({url:path,verb:'get',payload:null});}/**
   ...
   * 
     ...
     * @param string orderBy A comma separated list of sort statements in the format `(fieldname) [ASC|DESC]`, for example `id ASC`.
   * @return FetchResult
   */},{key:'listItemParameters',value:function listItemParameters(){var _ref174=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyId=_ref174.companyId,itemId=_ref174.itemId,filter=_ref174.filter,top=_ref174.top,skip=_ref174.skip,orderBy=_ref174.orderBy;var path=this.buildUrl({url:'/api/v2/companies/'+companyId+'/items/'+itemId+'/parameters',parameters:{$filter:filter,$top:top,$skip:skip,$orderBy:orderBy}});return this.restCall({url:path,verb:'get',payload:null});}/**
   ...
   * 
     ...
     * @param string orderBy A comma separated list of sort statements in the format `(fieldname) [ASC|DESC]`, for example `id ASC`.
   * @return FetchResult
   */},{key:'listItemsByCompany',value:function listItemsByCompany(){var _ref175=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyId=_ref175.companyId,filter=_ref175.filter,include=_ref175.include,top=_ref175.top,skip=_ref175.skip,orderBy=_ref175.orderBy;var path=this.buildUrl({url:'/api/v2/companies/'+companyId+'/items',parameters:{$filter:filter,$include:include,$top:top,$skip:skip,$orderBy:orderBy}});return this.restCall({url:path,verb:'get',payload:null});}/**
   * Retrieve all items
   *
   ...
   * 
     ...
     * @param string orderBy A comma separated list of sort statements in the format `(fieldname) [ASC|DESC]`, for example `id ASC`.
   * @return FetchResult
   */},{key:'queryItems',value:function queryItems(){var _ref176=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},filter=_ref176.filter,include=_ref176.include,top=_ref176.top,skip=_ref176.skip,orderBy=_ref176.orderBy;var path=this.buildUrl({url:'/api/v2/items',parameters:{$filter:filter,$include:include,$top:top,$skip:skip,$orderBy:orderBy}});return this.restCall({url:path,verb:'get',payload:null});}/**
   ...
   * @return object
   */},{key:'syncItems',value:function syncItems(){var _ref177=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyId=_ref177.companyId,model=_ref177.model;var path=this.buildUrl({url:'/api/v2/companies/'+companyId+'/items/sync',parameters:{}});return this.restCall({url:path,verb:'post',payload:model});}/**
   ...
   * @return object
   */},{key:'updateItem',value:function updateItem(){var _ref178=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyId=_ref178.companyId,id=_ref178.id,model=_ref178.model;var path=this.buildUrl({url:'/api/v2/companies/'+companyId+'/items/'+id,parameters:{}});return this.restCall({url:path,verb:'put',payload:model});}/**
   ...
   * 
     ...
     * @param object model The item object you wish to update.
   * @return object
   */},{key:'updateItemClassification',value:function updateItemClassification(){var _ref179=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyId=_ref179.companyId,itemId=_ref179.itemId,id=_ref179.id,model=_ref179.model;var path=this.buildUrl({url:'/api/v2/companies/'+companyId+'/items/'+itemId+'/classifications/'+id,parameters:{}});return this.restCall({url:path,verb:'put',payload:model});}/**
   ...
   * 
     ...
     * @param object model The item object you wish to update.
   * @return object
   */},{key:'updateItemParameter',value:function updateItemParameter(){var _ref180=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyId=_ref180.companyId,itemId=_ref180.itemId,id=_ref180.id,model=_ref180.model;var path=this.buildUrl({url:'/api/v2/companies/'+companyId+'/items/'+itemId+'/parameters/'+id,parameters:{}});return this.restCall({url:path,verb:'put',payload:model});}/**
   ...
   * @return object[]
   */},{key:'createJurisdictionOverrides',value:function createJurisdictionOverrides(){var _ref181=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},accountId=_ref181.accountId,model=_ref181.model;var path=this.buildUrl({url:'/api/v2/accounts/'+accountId+'/jurisdictionoverrides',parameters:{}});return this.restCall({url:path,verb:'post',payload:model});}/**
   ...
   * @return object[]
   */},{key:'deleteJurisdictionOverride',value:function deleteJurisdictionOverride(){var _ref182=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},accountId=_ref182.accountId,id=_ref182.id;var path=this.buildUrl({url:'/api/v2/accounts/'+accountId+'/jurisdictionoverrides/'+id,parameters:{}});return this.restCall({url:path,verb:'delete',payload:null});}/**
   ...
   * @return object
   */},{key:'getJurisdictionOverride',value:function getJurisdictionOverride(){var _ref183=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},accountId=_ref183.accountId,id=_ref183.id;var path=this.buildUrl({url:'/api/v2/accounts/'+accountId+'/jurisdictionoverrides/'+id,parameters:{}});return this.restCall({url:path,verb:'get',payload:null});}/**
   ...
   * 
     ...
     * @param string orderBy A comma separated list of sort statements in the format `(fieldname) [ASC|DESC]`, for example `id ASC`.
   * @return FetchResult
   */},{key:'queryJurisdictionOverrides',value:function queryJurisdictionOverrides(){var _ref185=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},filter=_ref185.filter,include=_ref185.include,top=_ref185.top,skip=_ref185.skip,orderBy=_ref185.orderBy;var path=this.buildUrl({url:'/api/v2/jurisdictionoverrides',parameters:{$filter:filter,$include:include,$top:top,$skip:skip,$orderBy:orderBy}});return this.restCall({url:path,verb:'get',payload:null});}/**
   ...
   * @return object
   */},{key:'updateJurisdictionOverride',value:function updateJurisdictionOverride(){var _ref186=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},accountId=_ref186.accountId,id=_ref186.id,model=_ref186.model;var path=this.buildUrl({url:'/api/v2/accounts/'+accountId+'/jurisdictionoverrides/'+id,parameters:{}});return this.restCall({url:path,verb:'put',payload:model});}/**
   ...
   * @return object[]
   */},{key:'createLocations',value:function createLocations(){var _ref187=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyId=_ref187.companyId,model=_ref187.model;var path=this.buildUrl({url:'/api/v2/companies/'+companyId+'/locations',parameters:{}});return this.restCall({url:path,verb:'post',payload:model});}/**
   ...
   * @return object[]
   */},{key:'deleteLocation',value:function deleteLocation(){var _ref188=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyId=_ref188.companyId,id=_ref188.id;var path=this.buildUrl({url:'/api/v2/companies/'+companyId+'/locations/'+id,parameters:{}});return this.restCall({url:path,verb:'delete',payload:null});}/**
   ...
   * @return object
   */},{key:'getLocation',value:function getLocation(){var _ref189=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyId=_ref189.companyId,id=_ref189.id,include=_ref189.include;var path=this.buildUrl({url:'/api/v2/companies/'+companyId+'/locations/'+id,parameters:{$include:include}});return this.restCall({url:path,verb:'get',payload:null});}/**
   ...
   * 
     ...
     * @param string orderBy A comma separated list of sort statements in the format `(fieldname) [ASC|DESC]`, for example `id ASC`.
   * @return FetchResult
   */},{key:'listLocationsByCompany',value:function listLocationsByCompany(){var _ref190=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyId=_ref190.companyId,filter=_ref190.filter,include=_ref190.include,top=_ref190.top,skip=_ref190.skip,orderBy=_ref190.orderBy;var path=this.buildUrl({url:'/api/v2/companies/'+companyId+'/locations',parameters:{$filter:filter,$include:include,$top:top,$skip:skip,$orderBy:orderBy}});return this.restCall({url:path,verb:'get',payload:null});}/**
   ...
   * 
     ...
     * @param string orderBy A comma separated list of sort statements in the format `(fieldname) [ASC|DESC]`, for example `id ASC`.
   * @return FetchResult
   */},{key:'queryLocations',value:function queryLocations(){var _ref191=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},filter=_ref191.filter,include=_ref191.include,top=_ref191.top,skip=_ref191.skip,orderBy=_ref191.orderBy;var path=this.buildUrl({url:'/api/v2/locations',parameters:{$filter:filter,$include:include,$top:top,$skip:skip,$orderBy:orderBy}});return this.restCall({url:path,verb:'get',payload:null});}/**
   ...
   * @return object
   */},{key:'updateLocation',value:function updateLocation(){var _ref192=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyId=_ref192.companyId,id=_ref192.id,model=_ref192.model;var path=this.buildUrl({url:'/api/v2/companies/'+companyId+'/locations/'+id,parameters:{}});return this.restCall({url:path,verb:'put',payload:model});}/**
   ...
   * 
     ...
     * @param int id The primary key of this location
   * @return object
   */},{key:'validateLocation',value:function validateLocation(){var _ref193=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyId=_ref193.companyId,id=_ref193.id;var path=this.buildUrl({url:'/api/v2/companies/'+companyId+'/locations/'+id+'/validate',parameters:{}});return this.restCall({url:path,verb:'get',payload:null});}/**
   ...
   * @return object
   */},{key:'adjustMultiDocumentTransaction',value:function adjustMultiDocumentTransaction(){var _ref194=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},code=_ref194.code,type=_ref194.type,include=_ref194.include,model=_ref194.model;var path=this.buildUrl({url:'/api/v2/transactions/multidocument/'+code+'/type/'+type+'/adjust',parameters:{include:include}});return this.restCall({url:path,verb:'post',payload:model});}/**
   ...
   * 
     ...
     * @param string type The transaction type for this MultiDocument transaction (See DocumentType::* for a list of allowable values)
   * @return object
   */},{key:'auditMultiDocumentTransaction',value:function auditMultiDocumentTransaction(){var _ref195=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},code=_ref195.code,type=_ref195.type;var path=this.buildUrl({url:'/api/v2/transactions/multidocument/'+code+'/type/'+type+'/audit',parameters:{}});return this.restCall({url:path,verb:'get',payload:null});}/**
   ...
   * @return object
   */},{key:'commitMultiDocumentTransaction',value:function commitMultiDocumentTransaction(){var _ref196=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},model=_ref196.model;var path=this.buildUrl({url:'/api/v2/transactions/multidocument/commit',parameters:{}});return this.restCall({url:path,verb:'post',payload:model});}/**
   ...
   * @return object
   */},{key:'createMultiDocumentTransaction',value:function createMultiDocumentTransaction(){var _ref197=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},include=_ref197.include,model=_ref197.model;var path=this.buildUrl({url:'/api/v2/transactions/multidocument',parameters:{$include:include}});return this.restCall({url:path,verb:'post',payload:model});}/**
   ...
   * 
     ...
     * @param string include Specifies objects to include in the response after transaction is created
   * @return object
   */},{key:'getMultiDocumentTransactionById',value:function getMultiDocumentTransactionById(){var _ref199=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},id=_ref199.id,include=_ref199.include;var path=this.buildUrl({url:'/api/v2/transactions/multidocument/'+id,parameters:{$include:include}});return this.restCall({url:path,verb:'get',payload:null});}/**
   ...
   * 
     ...
     * @param string orderBy A comma separated list of sort statements in the format `(fieldname) [ASC|DESC]`, for example `id ASC`.
   * @return FetchResult
   */},{key:'listMultiDocumentTransactions',value:function listMultiDocumentTransactions(){var _ref200=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},filter=_ref200.filter,include=_ref200.include,top=_ref200.top,skip=_ref200.skip,orderBy=_ref200.orderBy;var path=this.buildUrl({url:'/api/v2/transactions/multidocument',parameters:{$filter:filter,$include:include,$top:top,$skip:skip,$orderBy:orderBy}});return this.restCall({url:path,verb:'get',payload:null});}/**
   ...
   * @return object
   */},{key:'verifyMultiDocumentTransaction',value:function verifyMultiDocumentTransaction(){var _ref202=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},model=_ref202.model;var path=this.buildUrl({url:'/api/v2/transactions/multidocument/verify',parameters:{}});return this.restCall({url:path,verb:'post',payload:model});}/**
   ...
   * @return object
   */},{key:'voidMultiDocumentTransaction',value:function voidMultiDocumentTransaction(){var _ref203=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},code=_ref203.code,type=_ref203.type,model=_ref203.model;var path=this.buildUrl({url:'/api/v2/transactions/multidocument/'+code+'/type/'+type+'/void',parameters:{}});return this.restCall({url:path,verb:'post',payload:model});}/**
   * Create a new nexus
   *
   ...
   * @return object[]
   */},{key:'createNexus',value:function createNexus(){var _ref204=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyId=_ref204.companyId,model=_ref204.model;var path=this.buildUrl({url:'/api/v2/companies/'+companyId+'/nexus',parameters:{}});return this.restCall({url:path,verb:'post',payload:model});}/**
   ...
   * 
     ...
     * @param object[] model The nexus you wish to create.
   * @return object[]
   */},{key:'declareNexusByAddress',value:function declareNexusByAddress(){var _ref205=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyId=_ref205.companyId,model=_ref205.model;var path=this.buildUrl({url:'/api/v2/companies/'+companyId+'/nexus/byaddress',parameters:{}});return this.restCall({url:path,verb:'post',payload:model});}/**
   ...
   * @return object[]
   */},{key:'deleteNexus',value:function deleteNexus(){var _ref206=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyId=_ref206.companyId,id=_ref206.id;var path=this.buildUrl({url:'/api/v2/companies/'+companyId+'/nexus/'+id,parameters:{}});return this.restCall({url:path,verb:'delete',payload:null});}/**
   ...
   * @return object
   */},{key:'getNexus',value:function getNexus(){var _ref207=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyId=_ref207.companyId,id=_ref207.id;var path=this.buildUrl({url:'/api/v2/companies/'+companyId+'/nexus/'+id,parameters:{}});return this.restCall({url:path,verb:'get',payload:null});}/**
   ...
   * 
     ...
     * @param string formCode The form code that we are looking up the nexus for
   * @return object
   */},{key:'getNexusByFormCode',value:function getNexusByFormCode(){var _ref208=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyId=_ref208.companyId,formCode=_ref208.formCode;var path=this.buildUrl({url:'/api/v2/companies/'+companyId+'/nexus/byform/'+formCode,parameters:{}});return this.restCall({url:path,verb:'get',payload:null});}/**
   ...
   * 
     ...
     * @param string orderBy A comma separated list of sort statements in the format `(fieldname) [ASC|DESC]`, for example `id ASC`.
   * @return FetchResult
   */},{key:'listNexusByCompany',value:function listNexusByCompany(){var _ref209=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyId=_ref209.companyId,filter=_ref209.filter,include=_ref209.include,top=_ref209.top,skip=_ref209.skip,orderBy=_ref209.orderBy;var path=this.buildUrl({url:'/api/v2/companies/'+companyId+'/nexus',parameters:{$filter:filter,$include:include,$top:top,$skip:skip,$orderBy:orderBy}});return this.restCall({url:path,verb:'get',payload:null});}/**
   * Retrieve all nexus
   *
   ...
   * 
     ...
     * @param string orderBy A comma separated list of sort statements in the format `(fieldname) [ASC|DESC]`, for example `id ASC`.
   * @return FetchResult
   */},{key:'queryNexus',value:function queryNexus(){var _ref210=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},filter=_ref210.filter,include=_ref210.include,top=_ref210.top,skip=_ref210.skip,orderBy=_ref210.orderBy;var path=this.buildUrl({url:'/api/v2/nexus',parameters:{$filter:filter,$include:include,$top:top,$skip:skip,$orderBy:orderBy}});return this.restCall({url:path,verb:'get',payload:null});}/**
   ...
   * @return object
   */},{key:'updateNexus',value:function updateNexus(){var _ref211=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyId=_ref211.companyId,id=_ref211.id,model=_ref211.model;var path=this.buildUrl({url:'/api/v2/companies/'+companyId+'/nexus/'+id,parameters:{}});return this.restCall({url:path,verb:'put',payload:model});}/**
   ...
   * @return object
   */},{key:'dismissNotification',value:function dismissNotification(){var _ref212=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},id=_ref212.id;var path=this.buildUrl({url:'/api/v2/notifications/'+id+'/dismiss',parameters:{}});return this.restCall({url:path,verb:'put',payload:null});}/**
   ...
   * @return object
   */},{key:'getNotification',value:function getNotification(){var _ref213=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},id=_ref213.id;var path=this.buildUrl({url:'/api/v2/notifications/'+id,parameters:{}});return this.restCall({url:path,verb:'get',payload:null});}/**
   ...
   * 
     ...
     * @param string orderBy A comma separated list of sort statements in the format `(fieldname) [ASC|DESC]`, for example `id ASC`.
   * @return FetchResult
   */},{key:'listNotifications',value:function listNotifications(){var _ref214=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},filter=_ref214.filter,top=_ref214.top,skip=_ref214.skip,orderBy=_ref214.orderBy;var path=this.buildUrl({url:'/api/v2/notifications',parameters:{$filter:filter,$top:top,$skip:skip,$orderBy:orderBy}});return this.restCall({url:path,verb:'get',payload:null});}/**
   ...
   * @return object
   */},{key:'requestNewAccount',value:function requestNewAccount(){var _ref215=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},model=_ref215.model;var path=this.buildUrl({url:'/api/v2/accounts/request',parameters:{}});return this.restCall({url:path,verb:'post',payload:model});}/**
   ...
   * @return object
   */},{key:'requestNewEntitlement',value:function requestNewEntitlement(){var _ref216=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},id=_ref216.id,offer=_ref216.offer;var path=this.buildUrl({url:'/api/v2/accounts/'+id+'/entitlements/'+offer,parameters:{}});return this.restCall({url:path,verb:'post',payload:null});}/**
   ...
   * @return object[]
   */},{key:'createAccount',value:function createAccount(){var _ref217=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},model=_ref217.model;var path=this.buildUrl({url:'/api/v2/accounts',parameters:{}});return this.restCall({url:path,verb:'post',payload:model});}/**
   ...
   * @return object[]
   */},{key:'createNotifications',value:function createNotifications(){var _ref218=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},model=_ref218.model;var path=this.buildUrl({url:'/api/v2/notifications',parameters:{}});return this.restCall({url:path,verb:'post',payload:model});}/**
   ...
   * @return object[]
   */},{key:'createSubscriptions',value:function createSubscriptions(){var _ref219=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},accountId=_ref219.accountId,model=_ref219.model;var path=this.buildUrl({url:'/api/v2/accounts/'+accountId+'/subscriptions',parameters:{}});return this.restCall({url:path,verb:'post',payload:model});}/**
   ...
   * @return object[]
   */},{key:'deleteAccount',value:function deleteAccount(){var _ref220=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},id=_ref220.id;var path=this.buildUrl({url:'/api/v2/accounts/'+id,parameters:{}});return this.restCall({url:path,verb:'delete',payload:null});}/**
   ...
   * @return object[]
   */},{key:'deleteNotification',value:function deleteNotification(){var _ref221=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},id=_ref221.id;var path=this.buildUrl({url:'/api/v2/notifications/'+id,parameters:{}});return this.restCall({url:path,verb:'delete',payload:null});}/**
   ...
   * @return object[]
   */},{key:'deleteSubscription',value:function deleteSubscription(){var _ref222=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},accountId=_ref222.accountId,id=_ref222.id;var path=this.buildUrl({url:'/api/v2/accounts/'+accountId+'/subscriptions/'+id,parameters:{}});return this.restCall({url:path,verb:'delete',payload:null});}/**
   ...
   * @return string
   */},{key:'resetPassword',value:function resetPassword(){var _ref223=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},userId=_ref223.userId,unmigrateFromAi=_ref223.unmigrateFromAi,model=_ref223.model;var path=this.buildUrl({url:'/api/v2/passwords/'+userId+'/reset',parameters:{unmigrateFromAi:unmigrateFromAi}});return this.restCall({url:path,verb:'post',payload:model});}/**
   ...
   * @return object
   */},{key:'updateAccount',value:function updateAccount(){var _ref224=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},id=_ref224.id,model=_ref224.model;var path=this.buildUrl({url:'/api/v2/accounts/'+id,parameters:{}});return this.restCall({url:path,verb:'put',payload:model});}/**
   ...
   * @return object
   */},{key:'updateNotification',value:function updateNotification(){var _ref225=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},id=_ref225.id,model=_ref225.model;var path=this.buildUrl({url:'/api/v2/notifications/'+id,parameters:{}});return this.restCall({url:path,verb:'put',payload:model});}/**
   ...
   * @return object
   */},{key:'updateSubscription',value:function updateSubscription(){var _ref226=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},accountId=_ref226.accountId,id=_ref226.id,model=_ref226.model;var path=this.buildUrl({url:'/api/v2/accounts/'+accountId+'/subscriptions/'+id,parameters:{}});return this.restCall({url:path,verb:'put',payload:model});}/**
   * Download a report
   *
   ...
   * @return object
   */},{key:'downloadReport',value:function downloadReport(){var _ref227=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},id=_ref227.id;var path=this.buildUrl({url:'/api/v2/reports/'+id+'/attachment',parameters:{}});return this.restCall({url:path,verb:'get',payload:null});}/**
   ...
   * @return object
   */},{key:'getReport',value:function getReport(){var _ref228=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},id=_ref228.id;var path=this.buildUrl({url:'/api/v2/reports/'+id,parameters:{}});return this.restCall({url:path,verb:'get',payload:null});}/**
   ...
   * @return object[]
   */},{key:'initiateExportDocumentLineReport',value:function initiateExportDocumentLineReport(){var _ref229=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyId=_ref229.companyId,model=_ref229.model;var path=this.buildUrl({url:'/api/v2/companies/'+companyId+'/reports/exportdocumentline/initiate',parameters:{}});return this.restCall({url:path,verb:'post',payload:model});}/**
   ...
   * 
     ...
     * @param int top If nonzero, return no more than this number of results. Used with `$skip` to provide pagination for large datasets. Unless otherwise specified, the maximum number of records that can be returned from an API call is 1,000 records.
   * @return FetchResult
   */},{key:'listReports',value:function listReports(){var _ref230=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyId=_ref230.companyId,pageKey=_ref230.pageKey,skip=_ref230.skip,top=_ref230.top;var path=this.buildUrl({url:'/api/v2/reports',parameters:{companyId:companyId,pageKey:pageKey,$skip:skip,$top:top}});return this.restCall({url:path,verb:'get',payload:null});}/**
   ...
   * @return object[]
   */},{key:'createSettings',value:function createSettings(){var _ref231=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyId=_ref231.companyId,model=_ref231.model;var path=this.buildUrl({url:'/api/v2/companies/'+companyId+'/settings',parameters:{}});return this.restCall({url:path,verb:'post',payload:model});}/**
   ...
   * @return object[]
   */},{key:'deleteSetting',value:function deleteSetting(){var _ref232=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyId=_ref232.companyId,id=_ref232.id;var path=this.buildUrl({url:'/api/v2/companies/'+companyId+'/settings/'+id,parameters:{}});return this.restCall({url:path,verb:'delete',payload:null});}/**
   ...
   * @return object
   */},{key:'getSetting',value:function getSetting(){var _ref233=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyId=_ref233.companyId,id=_ref233.id;var path=this.buildUrl({url:'/api/v2/companies/'+companyId+'/settings/'+id,parameters:{}});return this.restCall({url:path,verb:'get',payload:null});}/**
   ...
   * 
     ...
     * @param string orderBy A comma separated list of sort statements in the format `(fieldname) [ASC|DESC]`, for example `id ASC`.
   * @return FetchResult
   */},{key:'listSettingsByCompany',value:function listSettingsByCompany(){var _ref234=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyId=_ref234.companyId,filter=_ref234.filter,include=_ref234.include,top=_ref234.top,skip=_ref234.skip,orderBy=_ref234.orderBy;var path=this.buildUrl({url:'/api/v2/companies/'+companyId+'/settings',parameters:{$filter:filter,$include:include,$top:top,$skip:skip,$orderBy:orderBy}});return this.restCall({url:path,verb:'get',payload:null});}/**
   ...
   * 
     ...
     * @param string orderBy A comma separated list of sort statements in the format `(fieldname) [ASC|DESC]`, for example `id ASC`.
   * @return FetchResult
   */},{key:'querySettings',value:function querySettings(){var _ref235=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},filter=_ref235.filter,include=_ref235.include,top=_ref235.top,skip=_ref235.skip,orderBy=_ref235.orderBy;var path=this.buildUrl({url:'/api/v2/settings',parameters:{$filter:filter,$include:include,$top:top,$skip:skip,$orderBy:orderBy}});return this.restCall({url:path,verb:'get',payload:null});}/**
   ...
   * @return object
   */},{key:'updateSetting',value:function updateSetting(){var _ref236=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyId=_ref236.companyId,id=_ref236.id,model=_ref236.model;var path=this.buildUrl({url:'/api/v2/companies/'+companyId+'/settings/'+id,parameters:{}});return this.restCall({url:path,verb:'put',payload:model});}/**
   ...
   * @return object
   */},{key:'getSubscription',value:function getSubscription(){var _ref237=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},accountId=_ref237.accountId,id=_ref237.id;var path=this.buildUrl({url:'/api/v2/accounts/'+accountId+'/subscriptions/'+id,parameters:{}});return this.restCall({url:path,verb:'get',payload:null});}/**
   ...
   * 
     ...
     * @param string orderBy A comma separated list of sort statements in the format `(fieldname) [ASC|DESC]`, for example `id ASC`.
   * @return FetchResult
   */},{key:'listSubscriptionsByAccount',value:function listSubscriptionsByAccount(){var _ref238=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},accountId=_ref238.accountId,filter=_ref238.filter,top=_ref238.top,skip=_ref238.skip,orderBy=_ref238.orderBy;var path=this.buildUrl({url:'/api/v2/accounts/'+accountId+'/subscriptions',parameters:{$filter:filter,$top:top,$skip:skip,$orderBy:orderBy}});return this.restCall({url:path,verb:'get',payload:null});}/**
   ...
   * 
     ...
     * @param string orderBy A comma separated list of sort statements in the format `(fieldname) [ASC|DESC]`, for example `id ASC`.
   * @return FetchResult
   */},{key:'querySubscriptions',value:function querySubscriptions(){var _ref239=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},filter=_ref239.filter,top=_ref239.top,skip=_ref239.skip,orderBy=_ref239.orderBy;var path=this.buildUrl({url:'/api/v2/subscriptions',parameters:{$filter:filter,$top:top,$skip:skip,$orderBy:orderBy}});return this.restCall({url:path,verb:'get',payload:null});}/**
   ...
   * @return object[]
   */},{key:'createTaxCodes',value:function createTaxCodes(){var _ref240=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyId=_ref240.companyId,model=_ref240.model;var path=this.buildUrl({url:'/api/v2/companies/'+companyId+'/taxcodes',parameters:{}});return this.restCall({url:path,verb:'post',payload:model});}/**
   ...
   * @return object[]
   */},{key:'deleteTaxCode',value:function deleteTaxCode(){var _ref241=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyId=_ref241.companyId,id=_ref241.id;var path=this.buildUrl({url:'/api/v2/companies/'+companyId+'/taxcodes/'+id,parameters:{}});return this.restCall({url:path,verb:'delete',payload:null});}/**
   ...
   * @return object
   */},{key:'getTaxCode',value:function getTaxCode(){var _ref242=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyId=_ref242.companyId,id=_ref242.id;var path=this.buildUrl({url:'/api/v2/companies/'+companyId+'/taxcodes/'+id,parameters:{}});return this.restCall({url:path,verb:'get',payload:null});}/**
   ...
   * 
     ...
     * @param string orderBy A comma separated list of sort statements in the format `(fieldname) [ASC|DESC]`, for example `id ASC`.
   * @return FetchResult
   */},{key:'listTaxCodesByCompany',value:function listTaxCodesByCompany(){var _ref243=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyId=_ref243.companyId,filter=_ref243.filter,include=_ref243.include,top=_ref243.top,skip=_ref243.skip,orderBy=_ref243.orderBy;var path=this.buildUrl({url:'/api/v2/companies/'+companyId+'/taxcodes',parameters:{$filter:filter,$include:include,$top:top,$skip:skip,$orderBy:orderBy}});return this.restCall({url:path,verb:'get',payload:null});}/**
   ...
   * 
     ...
     * @param string orderBy A comma separated list of sort statements in the format `(fieldname) [ASC|DESC]`, for example `id ASC`.
   * @return FetchResult
   */},{key:'queryTaxCodes',value:function queryTaxCodes(){var _ref244=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},filter=_ref244.filter,include=_ref244.include,top=_ref244.top,skip=_ref244.skip,orderBy=_ref244.orderBy;var path=this.buildUrl({url:'/api/v2/taxcodes',parameters:{$filter:filter,$include:include,$top:top,$skip:skip,$orderBy:orderBy}});return this.restCall({url:path,verb:'get',payload:null});}/**
   ...
   * @return object
   */},{key:'updateTaxCode',value:function updateTaxCode(){var _ref245=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyId=_ref245.companyId,id=_ref245.id,model=_ref245.model;var path=this.buildUrl({url:'/api/v2/companies/'+companyId+'/taxcodes/'+id,parameters:{}});return this.restCall({url:path,verb:'put',payload:model});}/**
   ...
   * @return object
   */},{key:'buildTaxContentFile',value:function buildTaxContentFile(){var _ref246=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},model=_ref246.model;var path=this.buildUrl({url:'/api/v2/pointofsaledata/build',parameters:{}});return this.restCall({url:path,verb:'post',payload:model});}/**
   ...
   * @return object
   */},{key:'buildTaxContentFileForLocation',value:function buildTaxContentFileForLocation(){var _ref247=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyId=_ref247.companyId,id=_ref247.id,date=_ref247.date,format=_ref247.format,partnerId=_ref247.partnerId,includeJurisCodes=_ref247.includeJurisCodes;var path=this.buildUrl({url:'/api/v2/companies/'+companyId+'/locations/'+id+'/pointofsaledata',parameters:{date:date,format:format,partnerId:partnerId,includeJurisCodes:includeJurisCodes}});return this.restCall({url:path,verb:'get',payload:null});}/**
   ...
   * @return object
   */},{key:'downloadTaxRatesByZipCode',value:function downloadTaxRatesByZipCode(){var _ref248=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},date=_ref248.date,region=_ref248.region;var path=this.buildUrl({url:'/api/v2/taxratesbyzipcode/download/'+date,parameters:{region:region}});return this.restCall({url:path,verb:'get',payload:null});}/**
   ...
   * @return object[]
   */},{key:'createTaxRules',value:function createTaxRules(){var _ref249=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyId=_ref249.companyId,model=_ref249.model;var path=this.buildUrl({url:'/api/v2/companies/'+companyId+'/taxrules',parameters:{}});return this.restCall({url:path,verb:'post',payload:model});}/**
   ...
   * @return object[]
   */},{key:'deleteTaxRule',value:function deleteTaxRule(){var _ref250=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyId=_ref250.companyId,id=_ref250.id;var path=this.buildUrl({url:'/api/v2/companies/'+companyId+'/taxrules/'+id,parameters:{}});return this.restCall({url:path,verb:'delete',payload:null});}/**
   ...
   * @return object
   */},{key:'getTaxRule',value:function getTaxRule(){var _ref251=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyId=_ref251.companyId,id=_ref251.id;var path=this.buildUrl({url:'/api/v2/companies/'+companyId+'/taxrules/'+id,parameters:{}});return this.restCall({url:path,verb:'get',payload:null});}/**
   ...
   * 
     ...
     * @param string orderBy A comma separated list of sort statements in the format `(fieldname) [ASC|DESC]`, for example `id ASC`.
   * @return FetchResult
   */},{key:'listTaxRules',value:function listTaxRules(){var _ref252=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyId=_ref252.companyId,filter=_ref252.filter,include=_ref252.include,top=_ref252.top,skip=_ref252.skip,orderBy=_ref252.orderBy;var path=this.buildUrl({url:'/api/v2/companies/'+companyId+'/taxrules',parameters:{$filter:filter,$include:include,$top:top,$skip:skip,$orderBy:orderBy}});return this.restCall({url:path,verb:'get',payload:null});}/**
   ...
   * 
     ...
     * @param string orderBy A comma separated list of sort statements in the format `(fieldname) [ASC|DESC]`, for example `id ASC`.
   * @return FetchResult
   */},{key:'queryTaxRules',value:function queryTaxRules(){var _ref253=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},filter=_ref253.filter,include=_ref253.include,top=_ref253.top,skip=_ref253.skip,orderBy=_ref253.orderBy;var path=this.buildUrl({url:'/api/v2/taxrules',parameters:{$filter:filter,$include:include,$top:top,$skip:skip,$orderBy:orderBy}});return this.restCall({url:path,verb:'get',payload:null});}/**
   ...
   * @return object
   */},{key:'updateTaxRule',value:function updateTaxRule(){var _ref254=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyId=_ref254.companyId,id=_ref254.id,model=_ref254.model;var path=this.buildUrl({url:'/api/v2/companies/'+companyId+'/taxrules/'+id,parameters:{}});return this.restCall({url:path,verb:'put',payload:model});}/**
   ...
   * @return object
   */},{key:'addLines',value:function addLines(){var _ref255=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},include=_ref255.include,model=_ref255.model;var path=this.buildUrl({url:'/api/v2/companies/transactions/lines/add',parameters:{$include:include}});return this.restCall({url:path,verb:'post',payload:model});}/**
   ...
   * @return object
   */},{key:'adjustTransaction',value:function adjustTransaction(){var _ref256=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyCode=_ref256.companyCode,transactionCode=_ref256.transactionCode,documentType=_ref256.documentType,include=_ref256.include,model=_ref256.model;var path=this.buildUrl({url:'/api/v2/companies/'+companyCode+'/transactions/'+transactionCode+'/adjust',parameters:{documentType:documentType,$include:include}});return this.restCall({url:path,verb:'post',payload:model});}/**
   ...
   * @return object
   */},{key:'auditTransaction',value:function auditTransaction(){var _ref257=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyCode=_ref257.companyCode,transactionCode=_ref257.transactionCode;var path=this.buildUrl({url:'/api/v2/companies/'+companyCode+'/transactions/'+transactionCode+'/audit',parameters:{}});return this.restCall({url:path,verb:'get',payload:null});}/**
   * Get audit information about a transaction
   *
   * Retrieve audit information about a transaction stored in AvaTax.
     *  
   ...
   * @return object
   */},{key:'auditTransactionWithType',value:function auditTransactionWithType(){var _ref258=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyCode=_ref258.companyCode,transactionCode=_ref258.transactionCode,documentType=_ref258.documentType;var path=this.buildUrl({url:'/api/v2/companies/'+companyCode+'/transactions/'+transactionCode+'/types/'+documentType+'/audit',parameters:{}});return this.restCall({url:path,verb:'get',payload:null});}/**
   ...
   * @return object
   */},{key:'bulkLockTransaction',value:function bulkLockTransaction(){var _ref259=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},model=_ref259.model;var path=this.buildUrl({url:'/api/v2/transactions/lock',parameters:{}});return this.restCall({url:path,verb:'post',payload:model});}/**
   ...
   * @return object
   */},{key:'changeTransactionCode',value:function changeTransactionCode(){var _ref260=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyCode=_ref260.companyCode,transactionCode=_ref260.transactionCode,documentType=_ref260.documentType,include=_ref260.include,model=_ref260.model;var path=this.buildUrl({url:'/api/v2/companies/'+companyCode+'/transactions/'+transactionCode+'/changecode',parameters:{documentType:documentType,$include:include}});return this.restCall({url:path,verb:'post',payload:model});}/**
   ...
   * 
     ...
     * @param object model The commit request you wish to execute
   * @return object
   */},{key:'commitTransaction',value:function commitTransaction(){var _ref261=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyCode=_ref261.companyCode,transactionCode=_ref261.transactionCode,documentType=_ref261.documentType,include=_ref261.include,model=_ref261.model;var path=this.buildUrl({url:'/api/v2/companies/'+companyCode+'/transactions/'+transactionCode+'/commit',parameters:{documentType:documentType,$include:include}});return this.restCall({url:path,verb:'post',payload:model});}/**
   ...
   * @return object
   */},{key:'createOrAdjustTransaction',value:function createOrAdjustTransaction(){var _ref262=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},include=_ref262.include,model=_ref262.model;var path=this.buildUrl({url:'/api/v2/transactions/createoradjust',parameters:{$include:include}});return this.restCall({url:path,verb:'post',payload:model});}/**
   ...
   * @return object
   */},{key:'createTransaction',value:function createTransaction(){var _ref263=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},include=_ref263.include,model=_ref263.model;var path=this.buildUrl({url:'/api/v2/transactions/create',parameters:{$include:include}});return this.restCall({url:path,verb:'post',payload:model});}/**
   ...
   * @return object
   */},{key:'deleteLines',value:function deleteLines(){var _ref264=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},include=_ref264.include,model=_ref264.model;var path=this.buildUrl({url:'/api/v2/companies/transactions/lines/delete',parameters:{$include:include}});return this.restCall({url:path,verb:'post',payload:model});}/**
   ...
   * 
     ...
     * @param string include Specifies objects to include in this fetch call
   * @return object
   */},{key:'getTransactionByCode',value:function getTransactionByCode(){var _ref265=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyCode=_ref265.companyCode,transactionCode=_ref265.transactionCode,documentType=_ref265.documentType,include=_ref265.include;var path=this.buildUrl({url:'/api/v2/companies/'+companyCode+'/transactions/'+transactionCode,parameters:{documentType:documentType,$include:include}});return this.restCall({url:path,verb:'get',payload:null});}/**
   * Retrieve a single transaction by code
   *
   ...
   * 
     ...
     * @param string include Specifies objects to include in this fetch call
   * @return object
   */},{key:'getTransactionByCodeAndType',value:function getTransactionByCodeAndType(){var _ref266=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyCode=_ref266.companyCode,transactionCode=_ref266.transactionCode,documentType=_ref266.documentType,include=_ref266.include;var path=this.buildUrl({url:'/api/v2/companies/'+companyCode+'/transactions/'+transactionCode+'/types/'+documentType,parameters:{$include:include}});return this.restCall({url:path,verb:'get',payload:null});}/**
   ...
   * 
     ...
     * @param string include Specifies objects to include in this fetch call
   * @return object
   */},{key:'getTransactionById',value:function getTransactionById(){var _ref267=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},id=_ref267.id,include=_ref267.include;var path=this.buildUrl({url:'/api/v2/transactions/'+id,parameters:{$include:include}});return this.restCall({url:path,verb:'get',payload:null});}/**
   ...
   * 
     ...
     * @param string orderBy A comma separated list of sort statements in the format `(fieldname) [ASC|DESC]`, for example `id ASC`.
   * @return FetchResult
   */},{key:'listTransactionsByCompany',value:function listTransactionsByCompany(){var _ref268=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyCode=_ref268.companyCode,dataSourceId=_ref268.dataSourceId,include=_ref268.include,filter=_ref268.filter,top=_ref268.top,skip=_ref268.skip,orderBy=_ref268.orderBy;var path=this.buildUrl({url:'/api/v2/companies/'+companyCode+'/transactions',parameters:{dataSourceId:dataSourceId,$include:include,$filter:filter,$top:top,$skip:skip,$orderBy:orderBy}});return this.restCall({url:path,verb:'get',payload:null});}/**
   ...
   * @return object
   */},{key:'lockTransaction',value:function lockTransaction(){var _ref269=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyCode=_ref269.companyCode,transactionCode=_ref269.transactionCode,documentType=_ref269.documentType,include=_ref269.include,model=_ref269.model;var path=this.buildUrl({url:'/api/v2/companies/'+companyCode+'/transactions/'+transactionCode+'/lock',parameters:{documentType:documentType,$include:include}});return this.restCall({url:path,verb:'post',payload:model});}/**
   ...
   * 
     ...
     * @param object model Information about the refund to create
   * @return object
   */},{key:'refundTransaction',value:function refundTransaction(){var _ref270=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyCode=_ref270.companyCode,transactionCode=_ref270.transactionCode,include=_ref270.include,documentType=_ref270.documentType,useTaxDateOverride=_ref270.useTaxDateOverride,model=_ref270.model;var path=this.buildUrl({url:'/api/v2/companies/'+companyCode+'/transactions/'+transactionCode+'/refund',parameters:{$include:include,documentType:documentType,useTaxDateOverride:useTaxDateOverride}});return this.restCall({url:path,verb:'post',payload:model});}/**
   ...
   * @return object
   */},{key:'settleTransaction',value:function settleTransaction(){var _ref271=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyCode=_ref271.companyCode,transactionCode=_ref271.transactionCode,documentType=_ref271.documentType,include=_ref271.include,model=_ref271.model;var path=this.buildUrl({url:'/api/v2/companies/'+companyCode+'/transactions/'+transactionCode+'/settle',parameters:{documentType:documentType,$include:include}});return this.restCall({url:path,verb:'post',payload:model});}/**
   ...
   * 
     ...
     * @param string include Specifies objects to include in this fetch call
   * @return object
   */},{key:'uncommitTransaction',value:function uncommitTransaction(){var _ref272=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyCode=_ref272.companyCode,transactionCode=_ref272.transactionCode,documentType=_ref272.documentType,include=_ref272.include;var path=this.buildUrl({url:'/api/v2/companies/'+companyCode+'/transactions/'+transactionCode+'/uncommit',parameters:{documentType:documentType,$include:include}});return this.restCall({url:path,verb:'post',payload:null});}/**
   ...
   * 
     ...
     * @param string include Specifies objects to include in this fetch call
   * @return object
   */},{key:'unvoidTransaction',value:function unvoidTransaction(){var _ref273=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyCode=_ref273.companyCode,transactionCode=_ref273.transactionCode,documentType=_ref273.documentType,include=_ref273.include;var path=this.buildUrl({url:'/api/v2/companies/'+companyCode+'/transactions/'+transactionCode+'/unvoid',parameters:{documentType:documentType,$include:include}});return this.restCall({url:path,verb:'post',payload:null});}/**
   ...
   * 
     ...
     * @param object model The data from an external system to reconcile against AvaTax
   * @return object
   */},{key:'verifyTransaction',value:function verifyTransaction(){var _ref274=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyCode=_ref274.companyCode,transactionCode=_ref274.transactionCode,documentType=_ref274.documentType,include=_ref274.include,model=_ref274.model;var path=this.buildUrl({url:'/api/v2/companies/'+companyCode+'/transactions/'+transactionCode+'/verify',parameters:{documentType:documentType,$include:include}});return this.restCall({url:path,verb:'post',payload:model});}/**
   * Void a transaction
   *
   * Voids the current transaction uniquely identified by this URL.
     *  
   ...
   * @return object
   */},{key:'voidTransaction',value:function voidTransaction(){var _ref275=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyCode=_ref275.companyCode,transactionCode=_ref275.transactionCode,documentType=_ref275.documentType,include=_ref275.include,model=_ref275.model;var path=this.buildUrl({url:'/api/v2/companies/'+companyCode+'/transactions/'+transactionCode+'/void',parameters:{documentType:documentType,$include:include}});return this.restCall({url:path,verb:'post',payload:model});}/**
   * Create a new UPC
   *
   ...
   * @return object[]
   */},{key:'createUPCs',value:function createUPCs(){var _ref276=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyId=_ref276.companyId,model=_ref276.model;var path=this.buildUrl({url:'/api/v2/companies/'+companyId+'/upcs',parameters:{}});return this.restCall({url:path,verb:'post',payload:model});}/**
   * Delete a single UPC
   *
   ...
   * @return object[]
   */},{key:'deleteUPC',value:function deleteUPC(){var _ref277=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyId=_ref277.companyId,id=_ref277.id;var path=this.buildUrl({url:'/api/v2/companies/'+companyId+'/upcs/'+id,parameters:{}});return this.restCall({url:path,verb:'delete',payload:null});}/**
   ...
   * @return object
   */},{key:'getUPC',value:function getUPC(){var _ref278=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyId=_ref278.companyId,id=_ref278.id;var path=this.buildUrl({url:'/api/v2/companies/'+companyId+'/upcs/'+id,parameters:{}});return this.restCall({url:path,verb:'get',payload:null});}/**
   ...
   * 
     ...
     * @param string orderBy A comma separated list of sort statements in the format `(fieldname) [ASC|DESC]`, for example `id ASC`.
   * @return FetchResult
   */},{key:'listUPCsByCompany',value:function listUPCsByCompany(){var _ref279=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyId=_ref279.companyId,filter=_ref279.filter,include=_ref279.include,top=_ref279.top,skip=_ref279.skip,orderBy=_ref279.orderBy;var path=this.buildUrl({url:'/api/v2/companies/'+companyId+'/upcs',parameters:{$filter:filter,$include:include,$top:top,$skip:skip,$orderBy:orderBy}});return this.restCall({url:path,verb:'get',payload:null});}/**
   * Retrieve all UPCs
   *
   ...
   * 
     ...
     * @param string orderBy A comma separated list of sort statements in the format `(fieldname) [ASC|DESC]`, for example `id ASC`.
   * @return FetchResult
   */},{key:'queryUPCs',value:function queryUPCs(){var _ref280=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},filter=_ref280.filter,include=_ref280.include,top=_ref280.top,skip=_ref280.skip,orderBy=_ref280.orderBy;var path=this.buildUrl({url:'/api/v2/upcs',parameters:{$filter:filter,$include:include,$top:top,$skip:skip,$orderBy:orderBy}});return this.restCall({url:path,verb:'get',payload:null});}/**
   * Update a single UPC
   *
   ...
   * @return object
   */},{key:'updateUPC',value:function updateUPC(){var _ref281=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyId=_ref281.companyId,id=_ref281.id,model=_ref281.model;var path=this.buildUrl({url:'/api/v2/companies/'+companyId+'/upcs/'+id,parameters:{}});return this.restCall({url:path,verb:'put',payload:model});}/**
   * Change Password
   *
   ...
   * @return string
   */},{key:'changePassword',value:function changePassword(){var _ref282=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},model=_ref282.model;var path=this.buildUrl({url:'/api/v2/passwords',parameters:{}});return this.restCall({url:path,verb:'put',payload:model});}/**
   * Create new users
   *
   ...
   * @return object[]
   */},{key:'createUsers',value:function createUsers(){var _ref283=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},accountId=_ref283.accountId,model=_ref283.model;var path=this.buildUrl({url:'/api/v2/accounts/'+accountId+'/users',parameters:{}});return this.restCall({url:path,verb:'post',payload:model});}/**
   ...
   * @return object[]
   */},{key:'deleteUser',value:function deleteUser(){var _ref284=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},id=_ref284.id,accountId=_ref284.accountId;var path=this.buildUrl({url:'/api/v2/accounts/'+accountId+'/users/'+id,parameters:{}});return this.restCall({url:path,verb:'delete',payload:null});}/**
   ...
   * @return object
   */},{key:'getUser',value:function getUser(){var _ref285=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},id=_ref285.id,accountId=_ref285.accountId,include=_ref285.include;var path=this.buildUrl({url:'/api/v2/accounts/'+accountId+'/users/'+id,parameters:{$include:include}});return this.restCall({url:path,verb:'get',payload:null});}/**
   ...
   * 
     ...
     * @param int accountId The accountID of the user you wish to get.
   * @return object
   */},{key:'getUserEntitlements',value:function getUserEntitlements(){var _ref286=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},id=_ref286.id,accountId=_ref286.accountId;var path=this.buildUrl({url:'/api/v2/accounts/'+accountId+'/users/'+id+'/entitlements',parameters:{}});return this.restCall({url:path,verb:'get',payload:null});}/**
   ...
   * 
     ...
     * @param string orderBy A comma separated list of sort statements in the format `(fieldname) [ASC|DESC]`, for example `id ASC`.
   * @return FetchResult
   */},{key:'listUsersByAccount',value:function listUsersByAccount(){var _ref287=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},accountId=_ref287.accountId,include=_ref287.include,filter=_ref287.filter,top=_ref287.top,skip=_ref287.skip,orderBy=_ref287.orderBy;var path=this.buildUrl({url:'/api/v2/accounts/'+accountId+'/users',parameters:{$include:include,$filter:filter,$top:top,$skip:skip,$orderBy:orderBy}});return this.restCall({url:path,verb:'get',payload:null});}/**
   * Retrieve all users
   *
   ...
   * 
     ...
     * @param string orderBy A comma separated list of sort statements in the format `(fieldname) [ASC|DESC]`, for example `id ASC`.
   * @return FetchResult
   */},{key:'queryUsers',value:function queryUsers(){var _ref288=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},include=_ref288.include,filter=_ref288.filter,top=_ref288.top,skip=_ref288.skip,orderBy=_ref288.orderBy;var path=this.buildUrl({url:'/api/v2/users',parameters:{$include:include,$filter:filter,$top:top,$skip:skip,$orderBy:orderBy}});return this.restCall({url:path,verb:'get',payload:null});}/**
   ...
   * @return object
   */},{key:'updateUser',value:function updateUser(){var _ref289=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},id=_ref289.id,accountId=_ref289.accountId,model=_ref289.model;var path=this.buildUrl({url:'/api/v2/accounts/'+accountId+'/users/'+id,parameters:{}});return this.restCall({url:path,verb:'put',payload:model});}/**
   ...
   * @return object
   */},{key:'getMySubscription',value:function getMySubscription(){var _ref290=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},serviceTypeId=_ref290.serviceTypeId;var path=this.buildUrl({url:'/api/v2/utilities/subscriptions/'+serviceTypeId,parameters:{}});return this.restCall({url:path,verb:'get',payload:null});}/**
   ...
   * 
   * @return FetchResult
   */},{key:'listMySubscriptions',value:function listMySubscriptions(){var _ref291=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{};_objectDestructuringEmpty(_ref291);var path=this.buildUrl({url:'/api/v2/utilities/subscriptions',parameters:{}});return this.restCall({url:path,verb:'get',payload:null});}/**
   ...
   * 
   * @return object
   */},{key:'ping',value:function ping(){var _ref292=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{};_objectDestructuringEmpty(_ref292);var path=this.buildUrl({url:'/api/v2/utilities/ping',parameters:{}});return this.restCall({url:path,verb:'get',payload:null});}}]);return AvaTaxClient;}();exports.default=AvaTaxClient;